...
from arch import Model, EMAHelper
from utils import (
    loss_registry, calculate_psnr, inverse_data_transform
)
...
def get_beta_schedule(beta_schedule, *, beta_start, beta_end, num_diffusion_timesteps):
    ...
    if beta_schedule == "quad":
        ...
        alphas_cumprod = np.cos((timesteps + s) / (1 + s) * np.pi * 0.5) ** 2
...
class Diffusion(object):
    ...
    def sg_sample_image(self, x, x_img, model, last=True):
        ...
        if self.args.sample_type == "generalized":
            ...
            from utils import generalized_steps, sr_generalized_steps, sg_generalized_steps
            ...
            from utils import ddpm_steps, sr_ddpm_steps, sg_ddpm_steps
